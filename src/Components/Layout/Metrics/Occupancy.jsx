...
function Occupancy() {
    return (
      ...
      <MetricsMenu />
      <h1 className="text-[28px] font-semibold">Occupancy</h1>

      <div className="w-full bg-white py-[30px] px-[40px]">
        <h1 className="text-[24px] font-semibold">Properties</h1>
        ...
        <div className="w-full flex flex-col gap-[20px] mt-[20px]">
            <div className="flex justify-between items-center border-b-[1px] border-[#EEEEEE] py-[20px]">
                <h3 className="text-[14px] text-[#16457E] font-semibold">Name</h3>
                <h3 className="text-[14px] text-[#16457E] font-semibold">Occupancy</h3>
            </div>
            <div className="flex justify-between items-center border-b-[1px] border-[#EEEEEE] py-[20px]">
